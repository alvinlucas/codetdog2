...
interface IGoogleReviewCardProps {
	name: string,
	content: string,
}

export default component$<IGoogleReviewCardProps>((props: IGoogleReviewCardProps) => {
	return (
		<div class="w-full bg-white rounded-xl text-black p-6 flex flex-col gap-2">
			<h3 class="text-xl font-bold text-[#767676]">{props.name}</h3>
